...
private GroupElement convert(Sentence grpelm,
		AbstractSyntax absSynFactory) {
...
private Atom convert(org.ruleml.psoa.parser.jaxb.Atom atom,
	...
	if (atom.getOid()!= null && atom.getOp() != null && atom.getArgs() != null
			&& atom.getSlot() != null)

		return absSynFactory.createAtom(convert(atom.getOid(), atom.getOp(), atom
				.getArgs(), atom.getSlot(), absSynFactory));
	if (atom.getOid()!= null && atom.getOp() != null && atom.getArgs() != null)

		return absSynFactory.createAtom(convert2MemberTuple(atom.getOid(), atom.getOp(), atom
				.getArgs(), absSynFactory));
	if (atom.getOid()!= null && atom.getOp() != null && atom.getSlot() != null)

		return absSynFactory.createAtom(convert2MemberSlot(atom.getOid(), atom.getOp(), atom
				.getSlot(), absSynFactory));

	return absSynFactory
			.createAtom(convert(atom.getOid(), atom.getOp(), absSynFactory));
}
	...
	for(Args tuple : tuples){
		for (java.lang.Object obj : tuple.getTERM()) {
			if (obj instanceof org.ruleml.psoa.parser.jaxb.Var) {
				...
				//result.addLast(convert((org.ruleml.psoa.parser.jaxb.Var) obj,absSynFactory));
				tup = convert((org.ruleml.psoa.parser.jaxb.Var) obj,absSynFactory);
				...
				//result.addLast(convert((org.ruleml.psoa.parser.jaxb.Const) obj, absSynFactory));
				tup = convert((org.ruleml.psoa.parser.jaxb.Ind) obj,absSynFactory);
				...
				//result.addLast(convert((org.ruleml.psoa.parser.jaxb.Expr) obj, absSynFactory));
				tup = convert((org.ruleml.psoa.parser.jaxb.Expr) obj,absSynFactory);
				...
				//result.addLast(convert((org.ruleml.psoa.parser.jaxb.ExternalTERMType) obj, absSynFactory));
				tup = convert((org.ruleml.psoa.parser.jaxb.ExternalTERMType) obj,absSynFactory);
			} else
 ...
 */
private AbstractSyntax.Equal convert(org.ruleml.psoa.parser.jaxb.Equal equal,
		AbstractSyntax absSynFactory) {
...
private Term convert(Expr expr, AbstractSyntax absSynFactory) {
	...
	if (expr.getOid() != null && expr.getOp() != null && expr.getArgs() != null
			&& expr.getSlot() != null) {
		return convert(expr.getOid(), expr.getOp(), expr.getArgs(), expr.getSlot(),
				absSynFactory);
	} else if (expr.getOid() != null && expr.getOp() != null && expr.getArgs() != null) {
		return convert2MemberTuple(expr.getOid(), expr.getOp(), expr.getArgs(), absSynFactory);
	} else if (expr.getOid() != null && expr.getOp() != null && expr.getSlot() != null) {
		return convert2MemberSlot(expr.getOid(), expr.getOp(), expr.getSlot(), absSynFactory);
